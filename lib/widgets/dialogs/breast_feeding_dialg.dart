...
class BreastFeedingDialog extends StatefulWidget {
  ...
  BreastFeedingDialog.add() : breastFeeding = null;

  BreastFeedingDialog.edit(this.breastFeeding);
...
class _BreastFeedingDialogState extends State<BreastFeedingDialog> {
  DateTime _timeStart;
  DateTime _timeEnd;
  String _note;
        ...
        new ListTile(
          title: new Row(
            ...
            children: <Widget>[
              ...
              new FlatButton(
                onPressed: () {
                  Navigator.of(context).pop(new BreastFeeding(
